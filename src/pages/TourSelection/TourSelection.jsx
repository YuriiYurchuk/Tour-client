...
import styles from "./TourSelection.module.scss";
import imgDesktop from "../../assets/images/TourSelection/banner-tour-selection-desktop.webp";
import imgTablet from "../../assets/images/TourSelection/banner-tour-selection-tablet.webp";
import imgMobile from "../../assets/images/TourSelection/banner-tour-selection-mobile.webp";
...
const TourSelection = () => {
  ...
  useEffect(() => {
    ...
    setFilters((prevFilters) => ({
      ...
      country: countryFromUrl || prevFilters.country,
    }));
  }, [location.search]);
  ...
  return (
    <section className={styles["tour-selection"]}>
      <Banner
        title="Підбір туру"
        subtitle="Ідеальна подорож починається тут"
